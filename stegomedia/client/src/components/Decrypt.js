    ...
    return (
        <div className="container flex justify-center items-center min-h-screen bg-gray-100">
            <div className="card w-[450px] p-6 bg-white border border-gray-300 shadow-lg rounded-lg">
                ...
                <h2 className="text-lg font-semibold mb-2">Upload Encrypted Image</h2>
                ...
                <button className="w-full px-4 py-2 bg-blue-500 text-white font-semibold rounded hover:bg-blue-600 transition duration-300" onClick={handleDecrypt}>
                    Decrypt
                </button>
